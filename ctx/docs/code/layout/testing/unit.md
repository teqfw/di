...
This document governs implementation-level unit testing only and does not redefine architectural or product-level semantics.
...
This unit-testing contract governs structural and behavioral verification of individual modules.
